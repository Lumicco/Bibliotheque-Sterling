...
// Vérifier si l'utilisateur est déjà connecté, le cas échéant redirection vers page login
...
<html lang="fr">
    ...
    <body>
        ...
        <div class="container" id="bienvenue">
            <h1 class="my-5">Bienvenue, <b><?php echo htmlspecialchars($_SESSION["username"]); ?></b> !</h1>
            <p>
